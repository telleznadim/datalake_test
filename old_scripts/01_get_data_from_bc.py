...
def getWebServicePagination(date_time, endpoint, company_bc, company_short, token):
    ...
    # except KeyError:
    #     print(f"Key error for endpoint: {endpoint}, company: {company_bc} ")
...
def main():
    ...
    #              "Posted_Sales_Credit_Memo_Lines_527_DW", "Value_Entries_5802_DW", "Resource_Ledger_Entries_202_DW", "General_Ledger_Entries_20_DW", "Posted_Service_Invoice_5977_DW", "Posted_Service_Invoice_Lines_5979_DW", ]
    endpoints = ["Sales_Order_Lines_46_DW"]
