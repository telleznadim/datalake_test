...
def query_items_by_bu_by_columns(container, company, endpoint, date_time_string, columns_list):
    print('\nQuerying for an  Item by Partition Key\n')
    ...
    df.to_csv(f'files/from_datalake/{company}_{endpoint}_{date_time_string}.csv.gz',
...
def main():
    ...
    data_to_read = [
        {"endpoint": "Items", "company": "TRS", "columns_list": [
            {"name": "No", "alias": "item_no"},
            {"name": "Description", "alias": "item_description"},
            {"name": "Blocked", "alias": "item_status"},
            {"name": "Inventory_Posting_Group", "alias": "inventory_posting_group"},
        ...
        {"endpoint": "Locations", "company": "TRS", "columns_list": [
        ...
        {"endpoint": "ItemLedgerEntries", "company": "TRS", "columns_list": [
        ...
        {"endpoint": "PurchaseLines", "company": "TRS", "columns_list": [
            {"name": "Document_Type", "alias": "document_type"},
            {"name": "Document_No", "alias": "document_no"},
        ...
        {"endpoint": "SalesLines", "company": "TRS", "columns_list": [
            {"name": "Document_Type", "alias": "document_type"},
            {"name": "Document_No", "alias": "document_no"},
            {"name": "Line_No", "alias": "line_no"},
    ...
    for data in data_to_read:
        ...
        query_items_by_bu_by_columns(
            container, data["company"], data["endpoint"], date_time_string, data["columns_list"])
